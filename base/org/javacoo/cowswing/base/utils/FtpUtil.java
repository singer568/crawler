...
public class FtpUtil {
	...
	public FtpUtil(String serverIP, String username, String password) {
	 ...
	 public static void main(String[] args) {
	  FtpUtil ftp = new FtpUtil("58.64.213.197",21, "nine", "duan1982");
	  ftp.connectServer();
	  //ftp.getFileList("webapps");
	  long result;
	try {
		System.out.println(ftp.isDirExist("webapps/test"));
		ftp.createDir("webapps/test/");

		System.out.println(ftp.isDirExist("webapps/test"));
		//result = ftp.uploadFile("F:/p2/CleverCalf/download/201304/25/20120410170236685.jpg", "webapps/test/20120410170236685.jpg");
		//System.out.println(result>=0 ? "上传成功！" : "上传失败！");
	} catch (Exception e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
	  
//	  boolean result = ftp.upload("F:/p2/CleverCalf/download", "webapps/test");
//	  System.out.println(result ? "上传成功！" : "上传失败！");
//	  List list = ftp.getFileList("webapps/test");
