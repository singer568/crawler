...
import org.javacoo.cowswing.plugin.gather.service.beans.RuleDataBaseBean;
import org.javacoo.cowswing.plugin.gather.service.beans.SelectValueBean;
import org.javacoo.cowswing.plugin.gather.ui.model.DataBaseComboBoxModel;
 ...
 * 远程数据库设置
 *@author DuanYong
 *@since 2013-3-2下午7:36:51
 *@version 1.0
 */
@Component("ruleDataBaseSettingPanel")
public class RuleDataBaseSettingPanel extends AbstractContentPanel<RuleDataBaseBean>{
	...
	protected void fillComponentData(RuleDataBaseBean ruleDataBaseBean) {
		...
		selectValueSelectListModel.addElement(new SelectValueBean(LanguageLoader.getString("System.DataBaseSettingValueKyContentBrief"),GatherConstant.DATA_BASE_SETTING_VALUES_KRY_CONTENT_BRIEF));
		...
		selectValueSelectListModel.addElement(new SelectValueBean(LanguageLoader.getString("System.DataBaseSettingValueKyContentTitleImg"),GatherConstant.DATA_BASE_SETTING_VALUES_KRY_CONTENT_TITLE_IMG));
		selectValueSelectListModel.addElement(new SelectValueBean(LanguageLoader.getString("System.DataBaseSettingValueKyContentResource"),GatherConstant.DATA_BASE_SETTING_VALUES_KRY_CONTENT_RESOURCE));
		selectValueSelectListModel.addElement(new SelectValueBean(LanguageLoader.getString("System.DataBaseSettingValueKyContentResourceName"),GatherConstant.DATA_BASE_SETTING_VALUES_KRY_CONTENT_RESOURCE_NAME));
		selectValueSelectListModel.addElement(new SelectValueBean(LanguageLoader.getString("System.DataBaseSettingValueKyContentResourceDesc"),GatherConstant.DATA_BASE_SETTING_VALUES_KRY_CONTENT_RESOURCE_DESC));
		selectValueSelectListModel.addElement(new SelectValueBean(LanguageLoader.getString("System.DataBaseSettingValueKyContentPage"),GatherConstant.DATA_BASE_SETTING_VALUES_KRY_CONTENT_PAGE));
		selectValueSelectListModel.addElement(new SelectValueBean(LanguageLoader.getString("System.DataBaseSettingValueKyContenComment"),GatherConstant.DATA_BASE_SETTING_VALUES_KRY_CONTENT_COMMENT));
