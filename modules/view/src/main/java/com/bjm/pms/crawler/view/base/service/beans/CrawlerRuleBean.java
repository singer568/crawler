 ...
 * 采集规则值对象
 *@author DuanYong
 *@since 2012-11-6上午9:13:13
 *@version 1.0
 */
public class CrawlerRuleBean extends CrawlerBaseBean{
	/**规则ID*/
	...
	/**
	 * @param imageSettingBean the imageSettingBean to set
	 */
	...
	/**
	 * @param ruleLocalBean the ruleLocalBean to set
	 */
