package com.bjm.pms.crawler.core.filter;
 ...
 */
public class CommentFilter extends AbstractFilter<String,String>{
	/**
	 * <li>约定采集参数格式如下</li>
	 ...
	 */
	public CommentFilter(String fethAreaTagStr, String deleteAreaTagStr){
		super(fethAreaTagStr,deleteAreaTagStr);
		this.filterName = Constants.FILTER_NAME_COMMENT_AREA;
	}
	/**
	 * 构建标签属性Map
	 */
