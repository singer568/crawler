...
public class MyBatisPersistenceImpl extends SqlSessionDaoSupport implements MyBatisPersistence{
	...
	/* (non-Javadoc)
	 * @see org.javacoo.icrawler.persistence.mybatis.MyBatisPersistence#save(String,Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.javacoo.icrawler.persistence.mybatis.MyBatisPersistence#modify(String,Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.javacoo.icrawler.persistence.mybatis.MyBatisPersistence#delete(String,Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.javacoo.icrawler.persistence.mybatis.MyBatisPersistence#get(String,Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.javacoo.icrawler.persistence.mybatis.MyBatisPersistence#getList(String,Object,int,int)
	 */
...
//			return new PaginationSupport(new LinkedList(), 0, tmpLimit, tmpOffset);//tmpMaxRows tmpOffset 暂时无用 先注释掉
	...
	/* (non-Javadoc)
	 * @see org.javacoo.persistence.mybatis.MyBatisPersistence#getList(java.lang.String, java.lang.Object)
	 */
	@Override
