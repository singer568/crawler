...
import com.bjm.pms.crawler.plugin.scheduler.core.Scheduler;
import com.bjm.pms.crawler.plugin.scheduler.core.SchedulerTask;
...
public class SchedulerTaskManageSvcImpl implements SchedulerTaskManageSvc {
    ...
    private class TaskManage{
    	...
    	private com.bjm.pms.crawler.plugin.scheduler.domain.Scheduler cmsScheduler;
    	public TaskManage(SchedulerTaskSvc schedulerSvc,com.bjm.pms.crawler.plugin.scheduler.domain.Scheduler cmsScheduler){
     ...
     */
	public boolean start(com.bjm.pms.crawler.plugin.scheduler.domain.Scheduler scheduler) {
     ...
     * @param scheduler 计划对象
     */
	public boolean stop(com.bjm.pms.crawler.plugin.scheduler.domain.Scheduler scheduler) {
     ...
     * @param scheduler 计划对象
     */
	public List<SchedulerTaskBean> associateTaskList(com.bjm.pms.crawler.plugin.scheduler.domain.Scheduler scheduler) {
		SchedulerTaskSvc schedulerSvc = getSchedulerTaskSvcByModuleType(scheduler.getServiceName());
