...
import com.bjm.pms.crawler.plugin.gather.ui.action.DeleteContentCommentAction;
import com.bjm.pms.crawler.plugin.gather.ui.action.ViewContentCommentAction;
 ...
 *@version 1.0
 */
@Component("contentCommentListPanel")
public class ContentCommentListPanel extends AbstractListPage implements ListSelectionListener {
	...
	public ContentCommentListPanel() {
		super();
	}
